...
def refresh_session_user(user):
    """
    Mantiene la sesión sincronizada con el usuario real
    """
...
def create_company():
    ...
    if request.method == 'POST':
        ...
        # Crear empresa con fecha controlada para evitar el error de los 60 días
        new_company = Company(
            name=business_name,
            rnc=rnc,
            # Forzamos los 30 días aquí para que el modelo no asuma nada extra
...
def settings():
    ...
    if not company_id:
        flash("No hay empresa asociada", "danger")
        return redirect(url_for('dashboard_bp.dashboard'))
    ...
    if request.method == 'POST':
        ...
        if logo_file and logo_file.filename:
            ...
            company.logo = upload_file(logo_file, "uploads/companies/logos")
...
# =====================================================
# SUBIR COMPROBANTE (Modificado para no acumular)
# =====================================================
...
def upload_receipt():
    ...
    if file and file.filename:
        receipt_path = upload_file(file, "uploads/payments")
        ...
        flash("¡Acceso restaurado por 24h! Estamos validando tu comprobante.", "success")
        return redirect(url_for('dashboard_bp.dashboard'))
...
# =====================================================
# SOLICITAR CAMBIO DE PLAN (Modificado para no acumular)
# =====================================================
...
def upgrade_plan():
    ...
    if file and selected_plan:
        path = upload_file(file, "uploads/payments")
